...
enum ConditionTypes
{
    ...
    CONDITION_OBJECT_ENTRY_GUID         = 31,           // OBJECT_TYPE_ID           entry          guid/Attackable    true if object is type OBJECT_TYPE_ID and the entry is 0 or matches entry of the object or matches guid of the object
