...
bool WorldSession::Update(uint32 diff, PacketFilter& updater)
{
    ...
    {
        // New msg system:
        if (g_wsHandlers.contains(static_cast<Opcodes>(packet->GetOpcode()))) {
            g_wsHandlers[static_cast<Opcodes>(packet->GetOpcode())](this, static_cast<uint32_t>(packet->GetOpcode()), currentTime, packet);
        }
