...
public:
    ...
    struct boss_xt002AI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetByteValue(UNIT_FIELD_BYTES_1, UNIT_BYTES_1_OFFSET_STAND_STATE, UNIT_STANDING); // emerge
            ...
            switch(events.ExecuteEvent())
            {
                ...
                case EVENT_HEALTH_CHECK:
                    ...
                    if (me->HealthBelowPct(_healthCheck))
                    {
                        ...
                        me->SetByteValue(UNIT_FIELD_BYTES_1, UNIT_BYTES_1_OFFSET_STAND_STATE, UNIT_SUBMERGED); // submerge with animation
