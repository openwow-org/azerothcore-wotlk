...
bool Player::TeleportToEntryPoint()
{
    ...
    {
        return Teleport(m_homebindMapId, m_homebindX, m_homebindY, m_homebindZ, m_homebindO);
    }
...
void Player::RepopAtGraveyard()
{
    ...
    if (ClosestGrave)
    {
        ...
        Teleport(m_homebindMapId, m_homebindX, m_homebindY, m_homebindZ, m_homebindO);
