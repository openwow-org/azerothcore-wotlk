...
void ScriptMgr::OnBeforeCreatureSelectLevel(const CreatureRec* cinfo, Creature* creature, uint8& level)
{
    ExecuteScript<AllCreatureScript>([&](AllCreatureScript* script)
    {
...
void ScriptMgr::Creature_SelectLevel(const CreatureRec* cinfo, Creature* creature)
{
    ExecuteScript<AllCreatureScript>([&](AllCreatureScript* script)
    {
