...
void AchievementMgr::CompletedAchievement(AchievementEntry const* achievement)
{
    ...
    if (_player->IsGameMaster())
    {
        ...
        ChatHandler(_player->User()).PSendSysMessage("Not available in GM mode");
        return;
    }
    ...
    if (achievement->flags & (ACHIEVEMENT_FLAG_REALM_FIRST_REACH | ACHIEVEMENT_FLAG_REALM_FIRST_KILL) && AccountMgr::IsPlayerAccount(_player->User()->GetSecurity()))
