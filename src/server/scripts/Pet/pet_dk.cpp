...
public:
    ...
    struct npc_pet_dk_ebon_gargoyleAI : ScriptedAI
    {
        ...
        {
            Unit* owner = me->GetOwner();
            if (owner && owner->GetTypeId() == ID_PLAYER && (!me->GetVictim() || me->GetVictim()->IsImmunedToSpell(sSpellMgr->GetSpellInfo(51963)) || !me->IsValidAttackTarget(me->GetVictim()) || !owner->CanSeeOrDetect(me->GetVictim())))
            {
