...
public:
    ...
    struct npc_ranshallaAI : public npc_escortAI, private DialogueHelper
    {
        ...
        void DoSummonPriestess()
        {
            ...
            if (Creature* priestess = me->SummonCreature(NPC_PRIESTESS_ELUNE, wingThicketLocations[0].m_positionX, wingThicketLocations[0].m_positionY, wingThicketLocations[0].m_positionZ, wingThicketLocations[0].GetFacing(), TEMPSUMMON_CORPSE_DESPAWN, 0))
            {
            ...
            if (Creature* priestess = me->SummonCreature(NPC_PRIESTESS_ELUNE, wingThicketLocations[1].m_positionX, wingThicketLocations[1].m_positionY, wingThicketLocations[1].m_positionZ, wingThicketLocations[1].GetFacing(), TEMPSUMMON_CORPSE_DESPAWN, 0))
            {
        ...
        void JustDidDialogueStep(int32 entry) override
        {
            switch (entry)
            {
                ...
                case SAY_PRIESTESS_ALTAR_13:
                    ...
                    if (Creature* guard = me->SummonCreature(NPC_GUARDIAN_ELUNE, wingThicketLocations[2].m_positionX, wingThicketLocations[2].m_positionY, wingThicketLocations[2].m_positionZ, wingThicketLocations[2].GetFacing(), TEMPSUMMON_CORPSE_DESPAWN, 0))
                    {
