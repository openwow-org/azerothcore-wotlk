...
void npc_escortAI::Start(bool isActiveAttacker /* = true*/, bool run /* = false */, WOWGUID playerGUID /* = WOWGUID::Empty */, Quest const* quest /* = nullptr */, bool instantRespawn /* = false */, bool canLoopPath /* = false */, bool resetWaypoints /* = true */)
{
    if (me->GetVictim())
    {
