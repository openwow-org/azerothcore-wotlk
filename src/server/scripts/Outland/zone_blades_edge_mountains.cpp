    ...
    struct npc_oscillating_frequency_scanner_master_bunnyAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            else
            {
                ...
                me->SummonCreature(NPC_OSCILLATING_FREQUENCY_SCANNER_TOP_BUNNY, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), me->GetFacing(), TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 50000);
                me->SummonGameObject(GO_OSCILLATING_FREQUENCY_SCANNER, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), me->GetFacing(), 0, 0, 0, 0, 50);
