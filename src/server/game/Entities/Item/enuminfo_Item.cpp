...
template <>
AC_API_EXPORT size_t EnumUtils<BAG_RESULT>::Count() { return 88; }

template <>
AC_API_EXPORT BAG_RESULT EnumUtils<BAG_RESULT>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
AC_API_EXPORT size_t EnumUtils<BAG_RESULT>::ToIndex(BAG_RESULT value)
{
    switch (value)
    {
